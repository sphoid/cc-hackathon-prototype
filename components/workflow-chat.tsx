  ...
  return (
    <div className="flex min-h-screen bg-zinc-50">
      ...
      <aside className="w-80 border-r border-zinc-200 bg-white p-4 flex flex-col">
        <Link href="/" className="text-sm text-zinc-500 hover:text-zinc-700 mb-2 transition-colors">
          &larr; All Demos
        </Link>
        <h1 className="text-lg font-bold mb-4">{workflowName}</h1>
          ...
          {!loading && !currentHtml && (
            <div className="flex items-center justify-center h-64 text-zinc-400">
              <div className="text-center">
                ...
                <p className="text-sm">
                  The engine will generate a {workflowName} UI based on the workflow schema
                </p>
              </div>
            </div>
          )}
